                        ...
                        while !current_lots.is_empty() {
                            match lot_selection_method {
                                ...
                                | LotSelectionMethod::LastInFirstOut => {
                                    if current_lots[0].acquisition.when
                                        != candidate_lots[0].acquisition.when
                                    {
                                        break;
                                    }
                                }
